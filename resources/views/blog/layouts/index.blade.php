...
<head>
    <meta charset="utf-8">
    <title>Tada & Blog - Home 2 Columns</title>
    ...
    ****************************************************************** --> 
    ...
    <header class="tada-container">
    	...
    	<div class="logo-container">
        	<a href="blog"><h1 style="font-family: Segoe Script; color: #000000">Tada Blog</h1></a>
            <p style="font-family: Segoe Script; color: #000000;"><i>-Zent Group-</i></p>
            ...
            <ul class="tada-menu">
                     <li><a href="#" class="active">HOME <i class="icon-arrow-down8"></i></a>
                        <ul class="submenu">
                            ...
                            <li><a href="home-2-columns.html" class="active">Home 2 Columns</a></li>
                    ...
                    <li><a href="#">FEATURES <i class="icon-arrow-down8"></i></a>
                        <ul class="submenu">
                            ...
                            <li><a href="blog/page-right-sidebar">Page + Right Sidebar</a></li>
                            <li><a href="page-with-left-sidebar.html">Page + Left Sidebar</a></li>                            
                            <li><a href="post.html">Post Full Width</a></li>
                            <li><a href="blog/post-right-sidebar">Post + Right Sidebar</a></li>
