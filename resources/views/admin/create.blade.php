 					...
 					<div class="x_content">
 						<form action="{{route('admin.store') }}" method="POST" role="form"  enctype="multipart/form-data">
 							...
 							<div class="form-group">
 								...
 								<input style="font-weight: bold;" type="text" class="form-control" name="title" id="title"  placeholder="Title">
 							</div>

 							<div class="form-group">
 								<label for="">Post by</label>
 								<input type="text" class="form-control"  name="name"  id="name"  placeholder="Post by ">
 							</div>
 							...
 							<div class="form-group">
 								...
 								<textarea  type="text" class="form-control"  name="content"  id="content"  placeholder="Content" cols="30" rows="30"></textarea>
 							</div>
